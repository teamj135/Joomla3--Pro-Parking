 ...
 * @since  1.6
 */
class ProparkingRulesLegacy implements RulesInterface
{
    /**
    ...
    public function parse(&$segments, &$vars)
    {
        ...
        $model        = ProparkingHelpersProparking::getModel($vars['view']);
